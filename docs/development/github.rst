...
Kids First uses Github exclusively for it's revision control as well as issue tracking, release tagging, and providing hooks to other systems.
Take a look at the `Kids First Organization <http://github.com/kids-first/>`_ on GitHub.
Read more 
...
Issue labels (See Labels_) should be chosen as needed to easily sort through the backlog.
...
If a repository has an *Issue Template*, make sure to follow it!
...
Repositories across the D3b Github organization that have frequent user feedback and bug reports should use our standard set of labels to tag issues shown.
...
The **help wanted** label is a special label that is displayed in repository summaries on Github (See the *11 Issues need help* .
...
The labels on pull requests are shared with those in issues (Labels_).
